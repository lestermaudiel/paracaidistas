...
const datatable = new Datatable('#tablaZonaSalto', {
    ...
    columns: [
        ...
        { title: 'Nombre', data: 'zona_salto_nombre' },
        ...
        { title: 'MODIFICAR', data: 'zona_salto_id', searchable: false, orderable: false,
          render: (data, type, row, meta) => {
            return `<button class="btn btn-warning" data-id='${data}' data-nombre='${row['zona_salto_nombre']}' data-latitud='${row['zona_salto_latitud']}' data-direc-latitud='${row['zona_salto_direc_latitud']}' data-longitud='${row['zona_salto_longitud']}' data-direc-longitud='${row['zona_salto_direc_longitud']}'>Modificar</button>` }
        },
        { title: 'ELIMINAR', 
          data: 'zona_salto_id',
