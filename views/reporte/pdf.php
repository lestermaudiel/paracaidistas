...
<head>
    ...
    <style>
        ...
        .escala-insignias {
            ...
            /* Alinea en línea */
            width: 50%;
            /* Asegura que ocupe la mitad del contenedor padre */
        }
...
<body>
    ...
    <h1 style="font-weight: bold; text-align: center; text-decoration: underline; font-size: 18px; margin-bottom: 20px;">
...
<div class="container">
    <div class="escala-insignias" style="margin-top: 30px;">
        ...
        <p class="paragrafatura" style="font-size: 14px;">ARTÍCULO 182. Las Alas de Paracaidismo Experto, se otorgarán después de haber efectuado un mínimo de treinta saltos conforme los requisitos siguientes:</p>
        <p class="paragrafatura" style="font-size: 14px;">A. De los treinta saltos, haber efectuado quince saltos en combate simulado, dos saltos nocturnos (uno como jefe de salto), y dos saltos en masa, como miembro de una Unidad que salte completa.</p>
        <p class="paragrafatura" style="font-size: 14px;">B. Ser graduado en una Escuela para Jefes de salto en el extranjero, o haber recibido y aprobado este entrenamiento en el Ejército de Guatemala.</p>
        <p class="paragrafatura" style="font-size: 14px;">C. Haber sido jefe en quince saltos o haber efectuado un salto en combate real.</p>
        <p class="paragrafatura" style="font-size: 14px;">D. Haber servido en situación de activo (saltando), en las Unidades de Paracaidista o en otras organizaciones de Paracaidista autorizado, por lo menos durante un año.</p>
        <p style="font-size: 14px;"><strong>III. ALAS DE PARACAIDISTA MAESTRO:</strong></p>
        <p class="paragrafatura" style="font-size: 14px;">ARTÍCULO 183. Las Alas de Paracaidista Maestro, se otorgarán después de haber efectuado un número de sesenta y cinco saltos y llenar cualesquiera de los requisitos siguientes:</p>
        <p class="paragrafatura" style="font-size: 14px;">A. De los sesenta y cinco saltos, haber efectuado veinticinco saltos en combate simulado, cuatro saltos nocturnos (dos como jefe de salto), dos saltos libre (uno de ellos con caída controlada) y cinco saltos en masa cuando la Unidad salte completa.</p>
        <p class="paragrafatura" style="font-size: 14px;">B. Haber sido jefe en treinta y tres saltos, o en dos o más saltos en combate real; y.</p>
        <p class="paragrafatura" style="font-size: 14px;">C. Haber servido en situación de activo (saltando), en las Unidades de Paracaidistas en el Ejército de Guatemala, o en otra organización de paracaidistas autorizado, durante un tiempo no menor de dos años</p>
    </div>
    <div class="images-container" style="float: right; width: 50%;">
        <img src="../public/images/paracaidista.jpg" alt="Paracaidista" style="width: 200px; height: auto; border-radius: 8px;">
        <img src="../public/images/experto.jpg" alt="Experto" style="width: 200px; height: auto; border-radius: 8px;">
        <img src="../public/images/maestro.jpg" alt="Maestro" style="width: 200px; height: auto; border-radius: 8px;">
    </div>
</div>
