...
<head>
    ...
    <style>
        body {
            ...
            /* Centra horizontalmente el contenido en la hoja */
        }

        .container {
            width: 80%;
            /* Ajusta el ancho de tu contenido según sea necesario */
        }
...
<body>
    <div class="container">
        <div class="first-page">
            <p style="text-align: center; font-weight: bold; text-decoration: underline;">RECORD INDIVIDUAL DE SALTO EN
                PARACAIDAS</p>
            <p>Nombre:
                <?= $info['nombre_paracaidista'] ?>
            </p>
            <p>Grado:
                <?= $info['grado'] ?>
            </p>
            ...
            <p>Fecha de Graduación como Paracaidista:
                <?= $info['fecha_graduacion'] ?>
            </p>
            <p>Unidad:
                <?= $info['unidad'] ?>
            </p>
    ...
    <pagebreak />
    <div class="container"
        style="width: 80%; background-color: #fff; padding: 20px; box-shadow: 0 0 20px rgba(0, 0, 0, 0.1); text-align: justify;">
        <div class="escala-insignias">
            <h1
                style="font-size: 24px; color: #333; text-transform: uppercase; letter-spacing: 1px; font-weight: bold; margin-bottom: 20px; text-align: center;">
                ESCALA DE INSIGNIAS</h1>
            <p style="font-size: 16px; margin-bottom: 10px;"><strong>I. ALAS DE PARACAIDISTA:</strong></p>
            <p style="font-size: 16px; margin-bottom: 10px;">Cinco saltos en paracaídas. Uno de ellos con equipo de
                combate.</p>
            <p><strong>II. ALAS DE PARACAIDISTA EXPERTO:</strong></p>
            <p class="paragrafatura">ARTÍCULO 182. Las Alas de Paracaidismo Experto, se otorgarán después de haber
                efectuado un mínimo de treinta saltos conforme los requisitos siguientes:</p>
            <p class="paragrafatura">A. De los treinta saltos, haber efectuado quince saltos en combate simulado, dos
                saltos nocturnos (uno como jefe de salto), y dos saltos en masa, como miembro de una Unidad que salte
                completa.</p>
            <p class="paragrafatura">B. Ser graduado en una Escuela para Jefes de salto en el extranjero, o haber
            ...
            <p class="paragrafatura">D. Haber servido en situación de activo (saltando), en las Unidades de Paracaidista
                o en otras organizaciones de Paracaidista autorizado, por lo menos durante un año.</p>
            <p><strong>III. ALAS DE PARACAIDISTA MAESTRO:</strong></p>
            <p class="paragrafatura">ARTÍCULO 183. Las Alas de Paracaidista Maestro, se otorgarán después de haber
                efectuado un número de sesenta y cinco saltos y llenar cualesquiera de los requisitos siguientes:</p>
            <p class="paragrafatura">A. De los sesenta y cinco saltos, haber efectuado veinticinco saltos en combate
            ...
            <p class="paragrafatura">B. Haber sido jefe en treinta y tres saltos, o en dos o más saltos en combate real;
                y.</p>
            <p class="paragrafatura">C. Haber servido en situación de activo (saltando), en las Unidades de
